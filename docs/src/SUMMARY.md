...
- [PATH Management](commands/path-management.md)
- [Validation](commands/validation.md)
- [Backup Operations](commands/backup.md)

# Features
- [Overview](features/overview.md)
- [Backup System](features/backup-system.md)
- [Shell Support](features/shell-support.md)
...
# Reference
- [Shell Configuration](reference/shell-config.md)
